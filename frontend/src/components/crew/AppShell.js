...
const ADMIN_NAV = [
  ...
  { to: "/admin/quests", label: "Quest Campaigns", icon: Map, color: "emerald" },
...
const USER_NAV = [
  ...
  { to: "/app/quests", label: "Quests", icon: Map, color: "emerald" },
  { to: "/app/challenges", label: "Challenges", icon: Zap, color: "lime" },
  { to: "/app/pet", label: "My Pet", icon: PawPrint, color: "violet" },
